...
export class CategoryService {
  ...
  protected convertDateFromClient(category: ICategory): ICategory {
    return Object.assign({}, category, {
      createdat: category.createdat?.isValid() ? category.createdat.format(DATE_FORMAT) : undefined,
      updatedat: category.updatedat?.isValid() ? category.updatedat.format(DATE_FORMAT) : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((category: ICategory) => {
        ...
        category.updatedat = category.updatedat ? dayjs(category.updatedat) : undefined;
      });
    }
    return res;
  }
